...
$requete_compteur = 'SELECT COUNT(*) AS total FROM message';
$resultat_compteur = mysqli_query($mysqli_link, $requete_compteur);
$compteur = mysqli_fetch_array($resultat_compteur);
$nombre_messages = $compteur['total'];
...
<?php include_once "../ressources/includes/menu-principal.php"; ?>
    <header class="bg-white shadow">
        <div class="mx-auto max-w-7xl py-3 px-4">
            ...
            <p class="text-gray-500 text-sm mt-1">Nombre de messages : <?php echo $nombre_messages; ?></p>
        </div>
    </header>
    <main>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr class="odd:bg-neutral-50 border-b-2 border-b-gray-100 last:border-b-0 first:border-t-2 first:border-t-gray-200">
                                ...
                                <td class="pl-8 p-4" data-label="Contenu"><?php echo mb_strimwidth($element["contenu"], 0, 50, "..."); ?></td>

...
<body>
    ...
    <header class="bg-white shadow">
        <div class="mx-auto max-w-7xl py-3 px-4 justify-between flex items-center">
            <div>
                <h1 class="text-3xl font-bold text-gray-900">Liste des articles</h1>
                <p class="text-sm text-gray-500 mt-1">Nombre d'articles : <?php echo $nombre_articles; ?></p>
            </div>

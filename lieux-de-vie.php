        ...
        <section>
            ...
            <ul class="liste-lieux">
                <li>
                    <div>
                    <figure class="image">
                        <img src="https://iut.univ-amu.fr/sites/default/files/styles/actu_full/public/media-image/JPE-2025-Arles.jpg?itok=Tl8ewNbE" alt="Bibliothèque">
                    </figure>
                    </div>
                ...
                <li>
                    <div>
                    <figure class="image">
                        <img src="https://u-paris.fr/wp-content/uploads/2019/03/resto_u_HAF.jpg" alt="Restaurant universitaire">
                    </figure>
                    </div>
                    <section class="textes">
                ...
                <li>
                    <div>
                    <figure class="image">
                        <img src="https://www.cyu.fr/sites/default/files/styles/paragraph_image/public/content/paragraphs/images/page-fablab.jpg.webp?itok=llHRbWnE" alt="Fablab">
                    </figure>
                    </div>
                    <section class="textes">

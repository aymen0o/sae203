...
<body>
    ...
    <main class="conteneur-principal conteneur-1280">
        ...
        <section class="colonne">
                    ...
                    <!--
                     ...
                     -->
                        <a href="article.php?id=<?php echo $article["id"]; ?>" class='article' id="<?php echo $article["id"]; ?>">
                            <div>
                                <img src='ressources/images/JPO.jpg' alt=''>
                            </div>
            ...
            <a class="jpo-banniere" title="Ouverture dans un nouvel onglet" target="_blank" href="https://www.cyu.fr/formation/s-orienter-construire-son-projet/salons-journees-portes-ouvertes/journees-portes-ouvertes-jpo">
